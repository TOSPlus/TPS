...
【桌面】
优化  应用恢复后快捷图标尺寸大小的显示问题
修复  应用恢复过程中一键整理，恢复完成后拖动第三方应用，桌面顶部显示“删除”的问题
...
【云服务】
新增  云端联系人重复检测，下发通知跳转联系人去重界面
优化  下载失败图标的加载方式，防止出现异常
修复  备份列表12小时制的上午和下午以本地而不是时间戳为准的问题

【日历】
优化  英文环境下编辑界面的时间显示的问题
修复  日历小部件跨天日程时间显示的问题
修复  英文环境下月视图放假安排不能正确显示的问题
修复  TencentOS账号名称修改后再重新登录后，日历账号未更新名称的问题

【应用管理】
修复  首次安装文件管理器中的应用程序时出现停止响应的问题（三星I9308机型）

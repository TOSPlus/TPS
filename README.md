...
【桌面】
修复  下载应用，桌面图标无水波纹显示的问题
修复  恢复数据过程中一键整理，导致微信自动下载失败的问题
修复  桌面布局恢复时，一键整理导致小工具图标无法删除的问题
...
优化  来去电页面标记号码的显示逻辑
修复  随机出现的电话已停止的问题
修复  卡2移动网络设置无效的问题（酷派大神F2机型）

【通知栏/状态栏】
修复  音量键导致的沉浸式显示异常问题
修复  只插卡2时，通知栏数据业务开关失效的问题（酷派大神F2机型）

【应用商店】
修复  下载任务时清除缓存导致下载失败的问题
修复  必备页面，页脚数目错误的问题

【应用管理】
修复  刷机精灵PC端无法读取联系人的问题

【下载管理】
修复  应用商店下载获取不到文件长度后提示异常的问题
修复  断开WiFi打开数据网络时，偶尔会继续下载的问题

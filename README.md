...
新增  应用安装进度展示功能
修复  盖伦主题解锁卡住的问题
修复  进入应用商店下载应用，桌面出现崩溃的问题
修复  远程协助没有标记为系统系统应用的问题

【主题】
新增  3D主题《提莫》
修复  秘密实验室解锁按钮右半部分无响应的问题（720P分辨率机型） 

【来去电】
修复  电话崩溃的问题（一加A1001机型）

【通知栏/状态栏】
修复  京东等营养首次启动时状态栏变色慢的问题
修复  刷机导致的home键不可用，通知设置按钮失效的问题
修复  待机来QQ消息，亮屏查看时状态栏没有沉浸的问题

【设置】
新增  设置界面云服务的状态信息

【文件管理】
修复  进入文件管理界面最近列表不刷新的问题
修复  问家家标注过长的问题
修复  收到一张蓝牙分享的照片，加载不了缩略图的问题
修复  拍照后最近列表刷新不出的问题（N5 5.1机型）
修复  进入RE文件管理器查看文件时，文件出现崩溃的问题
...
新增  设置入口处显示剩余空间
新增  QQ快捷登录
新增  web端数据管理（联系人、短信、相册）
优化  首页同步状态（同步、暂停、完成、内容）

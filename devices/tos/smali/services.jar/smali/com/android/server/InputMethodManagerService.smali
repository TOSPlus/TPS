...
.method private qromShowInputDialog(Ljava/util/List;IZZ)V
    .locals 7
    .param p2, "checkedItem"    # I
    .param p3, "showSubtypes"    # Z
    ...
    .prologue
    .line 2681
    .local p1, "imList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    iget-object v4, p0, Lcom/android/server/InputMethodManagerService;->mContext:Landroid/content/Context;
    ...
    .line 2690
    iput-object v3, p0, Lcom/android/server/InputMethodManagerService;->mSwitchingDialogTitleView:Landroid/view/View;

    .line 2692
    iget-object v4, p0, Lcom/android/server/InputMethodManagerService;->mSwitchingDialogTitleView:Landroid/view/View;
    ...
    invoke-direct {v0, v4, v5, p1, p2}, Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;-><init>(Landroid/content/Context;ILjava/util/List;I)V

    .line 2717
    .local v0, "adapter":Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;
    iget-object v4, p0, Lcom/android/server/InputMethodManagerService;->mDialogBuilder:Landroid/app/AlertDialog$Builder;

    new-instance v5, Lcom/android/server/InputMethodManagerService$7;

    invoke-direct {v5, p0, v0}, Lcom/android/server/InputMethodManagerService$7;-><init>(Lcom/android/server/InputMethodManagerService;Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;)V

    invoke-virtual {v4, v0, p2, v5}, Landroid/app/AlertDialog$Builder;->setSingleChoiceItems(Landroid/widget/ListAdapter;ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v6, Lcom/android/server/InputMethodManagerService$8;

    invoke-direct {v6, p0}, Lcom/android/server/InputMethodManagerService$8;-><init>(Lcom/android/server/InputMethodManagerService;)V
    ...
    const-string v5, "Select input method"
...
.method private showInputMethodMenuInternal(Z)V
    ...
    iget-object v7, v0, Lcom/android/server/InputMethodManagerService;->mContext:Landroid/content/Context;
    ...
    .line 2619
    .local v15, "lastInputMethodId":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->getSelectedInputMethodSubtypeId(Ljava/lang/String;)I

    move-result v16

    .line 2622
    .local v16, "lastInputMethodSubtypeId":I
    move-object/from16 v0, p0
    ...
    .line 2625
    .local v12, "immis":Ljava/util/HashMap;, "Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    if-eqz v12, :cond_0
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/android/server/InputMethodManagerService$InputMethodAndSubtypeListManager;->getSortedInputMethodAndSubtypeList(ZZZ)Ljava/util/List;

    move-result-object v11

    .line 2635
    .local v11, "imList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    const/16 v18, -0x1
    ...
    .line 2639
    .local v8, "currentImi":Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 2644
    .end local v8    # "currentImi":Landroid/view/inputmethod/InputMethodInfo;
    ...
    check-cast v14, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;

    .line 2650
    .local v14, "item":Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    move-object/from16 v0, p0
    ...
    iget-object v0, v14, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mImi:Landroid/view/inputmethod/InputMethodInfo;
    ...
    iget v0, v14, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mSubtypeId:I
    ...
    .line 2661
    .end local v14    # "item":Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    :cond_6
    const/16 v18, 0x0

    sget-object v20, Lcom/android/internal/R$styleable;->DialogPreference:[I
    ...
    invoke-virtual {v7, v0, v1, v2, v3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    new-instance v20, Lcom/android/server/InputMethodManagerService$5;
    ...
    invoke-direct {v0, v11, v6, v1, v13}, Lcom/android/server/InputMethodManagerService;->qromShowInputDialog(Ljava/util/List;IZZ)V
    ...
    .end local v10    # "i":I
    .end local v11    # "imList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    .end local v12    # "immis":Ljava/util/HashMap;, "Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    :catchall_0
    move-exception v18
